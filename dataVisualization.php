                ...
                <div class="row">
                    <div class="col-lg-2 col-md-3 fixed-top sideNav">
                        ...
                        <ul class="navbar-nav flex-column mt-4">
                            ...
                            <li class="nav-item"><a href="sensors.php" class="nav-link p-3 mb-2 text-white sideNavLink">Sensor</a></li>
                            <li class="nav-item"><a href="dataVisualization.php" class="nav-link p-3 mb-2 current text-white">Visualization</a></li>
                            <?php
