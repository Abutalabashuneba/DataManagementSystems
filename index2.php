                ...
                <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
                    <nav>
                        <ul class="pagination justify-content-center">
                            <li class="page-item"><a href="index.php" class="page-link"><span class="badge">Chicken</span></a></li>
                            <li class="page-item active"><a href="index2.php" class="page-link"><span class="badge">BSF</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
